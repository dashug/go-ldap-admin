...
- [🙏 致谢与分支说明](#-%E8%87%B4%E8%B0%A2%E4%B8%8E%E5%88%86%E6%94%AF%E8%AF%B4%E6%98%8E)
- [🚀 本分支升级清单](#-%E6%9C%AC%E5%88%86%E6%94%AF%E5%8D%87%E7%BA%A7%E6%B8%85%E5%8D%95)
- [🏊 在线体验](#-%E5%9C%A8%E7%BA%BF%E4%BD%93%E9%AA%8C)
- [👨‍💻 项目地址](#-%E9%A1%B9%E7%9B%AE%E5%9C%B0%E5%9D%80)
- [🔗 文档快链](#-%E6%96%87%E6%A1%A3%E5%BF%AB%E9%93%BE)
- [🧩 目录服务配置（OpenLDAP / AD）](#-%E7%9B%AE%E5%BD%95%E6%9C%8D%E5%8A%A1%E9%85%8D%E7%BD%AEopenldap--ad)
...
本仓库基于原作者 [eryajf/go-ldap-admin](https://github.com/eryajf/go-ldap-admin) 深度二次开发，首先感谢原作者和历史贡献者的开源工作与长期维护。
...
我们在保留原项目核心能力和交互风格的基础上，重点补齐了面向企业落地的“AD兼容 + 向导式配置”能力。

## 🚀 本分支升级清单

### 目录服务能力升级

- 新增 `OpenLDAP / Windows AD` 双模式（`ldap.directory-type` 可切换）。
- AD 模式下适配用户/组对象模型、用户 DN 规则、组成员属性与密码处理逻辑。
- 后端配置接口支持读取并保存目录连接参数（地址、DN、类型、初始密码等）。

### 配置体验升级（小白可用）

- 前端新增“目录快速配置”入口，支持可视化填写、保存目录配置。
- 前端新增“平台对接向导”，支持钉钉/企微/飞书分平台配置。
- 新增“测试连接”接口与按钮，配置前可先验证凭证可用性。

### 第三方平台对接升级

- 支持通过界面完成钉钉、企微、飞书参数配置并写回后端配置文件。
- 支持在配置阶段测试第三方平台连通性，降低首次接入失败成本。
